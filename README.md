...
###### *이번 프로젝트에서는 게시글과 댓글의 좋아요 기능을 이전과는 다른 방식으로 구현해 보았습니다.<br> 게시글과 댓글의 기본 키를 동일한 시퀀스 테이블에서 가져오도록 하여, 좋아요 테이블을 별도로 나누지 않고 하나의 테이블에서 관리할 수 있도록 설계했습니다.<br> 이를 통해 테이블 구조를 더욱 간결하게 유지할 수 있었으며, 관리의 복잡성을 줄일 수 있었습니다.*
